...
export default function Dashboard() {
      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center space-y-4 px-6">
          ...
          <p className="text-muted-foreground text-sm max-w-xs">
            Analyze a resume to start seeing insights here.
          </p>
          <Button
  ...
  const categoryAverages = [
    ...
    { label: "Skills Relevance", score: Number(averages.avg_skills) || 0 },
    {
      ...
      score: Number(averages.avg_experience) || 0,
    },
  ...
  const distributionBars = [
    {
      label: "Poor (0–39)",
      count: Number(distribution.poor),
      color: "#dc2626",
    },
    {
      label: "Fair (40–59)",
      count: Number(distribution.fair),
      color: "#d97706",
    },
    {
      label: "Good (60–79)",
      count: Number(distribution.good),
      color: "#2563eb",
    },
    {
      label: "Strong (80–100)",
      count: Number(distribution.strong),
      color: "#16a34a",
    },
  ];
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground text-sm">
              Insights across all resume analyses
            </p>
          </div>
          <button
          ...
          <Card className="border border-gray-100 shadow-sm">
            <CardContent className="p-6 space-y-1">
              ...
              <p
                ...
                style={{ color: getScoreColor(Number(averages.avg_overall)) }}
              >
            ...
            <CardContent className="p-6 space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {topMissingKeywords.length > 0 ? (
                  topMissingKeywords.map((k: any, i: number) => (
                    <Badge
                      key={i}
                      variant="outline"
