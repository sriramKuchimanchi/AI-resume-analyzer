...
export default function Score() {
  ...
  if (!result) {
    return (
      <div className="text-center mt-20 text-gray-400">
        No analysis found.{" "}
        <button className="underline" onClick={() => navigate("/analyze")}>
          Go back
        </button>
      </div>
    );
    ...
    return (
      <div className="relative inline-flex items-center justify-center shrink-0">
        ...
        <div className="absolute">
          <p className="font-bold text-white" style={{ fontSize: size * 0.24 }}>
            {Math.round(score)}
          </p>
        </div>
      </div>
  ...
  const handleJobMatch = async () => {
    ...
    try {
      ...
      const file = new File([blob], resumeName || "resume.pdf", {
      ...
      setMatchError("Match failed. Please try again.");
    } finally {
  ...
  const actionBtn = (
    ...
    <button
      ...
      style={{
        backgroundColor: disabled ? "#e5e7eb" : SIDEBAR_BG,
    ...
    switch (activeTab) {
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              {strengths.map((s: string, i: number) => (
                ...
                >
                  <span className="text-green-500 mt-0.5 shrink-0 font-bold text-lg">
                    ↑
                  </span>
      ...
      case "weaknesses":
        return (
          <div className="space-y-5">
            <div>
              <h2 className="text-2xl font-bold text-gray-800">Weaknesses</h2>
              <p className="text-base text-gray-400 mt-1">
            ...
            <div className="space-y-3">
              {weaknesses.map((w: string, i: number) => (
                ...
                >
                  <span className="text-red-400 mt-0.5 shrink-0 font-bold text-lg">
                    ↓
                  </span>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              {improvements.map((item: string, i: number) => (
                ...
                >
                  <span className="text-sm font-bold text-gray-300 mt-0.5 w-5 shrink-0">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {keywordsDetected.length > 0 ? (
                  keywordsDetected.map((k: string, i: number) => (
                    <Badge
                      key={i}
                      variant="secondary"
                ...
                {missingKeywords.length > 0 ? (
                  missingKeywords.map((k: string, i: number) => (
                    <Badge
                      key={i}
                      variant="outline"
                      className="text-sm font-medium text-red-500 border-red-200"
                    >
                      + {k}
                    </Badge>
                  ))
              ...
              <div className="space-y-6 pt-2">
                <div className="flex items-center gap-6 p-6 bg-gray-50 rounded-2xl border border-gray-100">
                  ...
                  <div className="space-y-1">
                    ...
                    <p
                      ...
                      style={{ color: getScoreColor(matchResult.matchScore) }}
                    >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    {matchResult.matchedSkills?.map((s: string, i: number) => (
                      ...
                      >
                        <span className="text-green-500 shrink-0 font-bold mt-0.5">
                          ✓
                        </span>
                        {s}
                      </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {matchResult.missingSkills?.map((s: string, i: number) => (
                      <div
                        ...
                        className="flex items-start gap-2 text-sm text-gray-700"
                      >
                        <span className="text-red-400 shrink-0 font-bold mt-0.5">
                          ✗
                        </span>
                        {s}
                      </div>
                ...
                {matchResult.tailoredImprovements?.length > 0 && (
                  <div className="space-y-3">
                    ...
                    {matchResult.tailoredImprovements.map(
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-base text-gray-400 mt-1">
                Paste a bullet point and get an AI-powered rewrite
              </p>
            </div>
            <div className="space-y-3">
              <textarea
              ...
              {actionBtn(
                handleRewrite,
                rewriteLoading || !bulletInput.trim(),
                rewriteLoading,
                "Rewrite with AI",
                "Rewriting...",
              )}
              {rewriteError && (
                <p className="text-sm text-red-500">{rewriteError}</p>
              )}
            </div>
            {rewriteResult && (
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-4 bg-green-50 rounded-xl border border-green-100 relative">
                    <p className="text-sm text-gray-800 leading-relaxed font-medium pr-16">
                ...
                {rewriteResult.improvements?.length > 0 && (
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {rewriteResult.improvements.map(
                        (imp: string, i: number) => (
                          <Badge
                            key={i}
                            variant="secondary"
  ...
  return (
    ...
    >
      <div
        className="w-full border-b border-gray-200 bg-white flex items-center justify-between px-8"
        style={{ height: "56px", flexShrink: 0 }}
      >
        <span
          className="font-bold text-lg cursor-pointer tracking-tight"
          onClick={() => navigate("/")}
        >
          ResumeAI
        </span>
      ...
      <div className="flex flex-1 overflow-hidden">
        <div
          ...
          style={{ width: "225px", flexShrink: 0, backgroundColor: SIDEBAR_BG }}
        >
          <div
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: SIDEBAR_LABEL }}>
                  Overall
                </p>
              </div>
            </div>
          ...
          <div className="p-3 flex-1 space-y-0.5">
            <p
              className="text-xs font-semibold tracking-widest px-3 py-2 uppercase"
              style={{ color: SIDEBAR_LABEL }}
            >
              Analysis
            </p>
        ...
        <div className="flex-1 overflow-y-auto bg-white">
          ...
          <div className="px-10 pb-10 max-w-2xl">{renderTabContent()}</div>
        </div>
